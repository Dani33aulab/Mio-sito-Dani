<table class="table table-striped table-hover border">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>($metaType == "tags")</td>
            <td>
                <form action="{{route('admin.editTag', ['tag' => $metaInfo])}}" method="POST"></form>
                     @csrf
                    @method('put')
            ...
            <td>
                <form action="{{route('admin.deleteTag', ['tag' => $metaInfo])}}" method="POST"></form>
                @csrf
                @method('delete')
            ...
            <td>
                    ...
                    <form action="{{route('admin.deleteCategory', ['category' => $metaInfo])}}" method="POST"></form>
                    @csrf
                    @method('delete')
